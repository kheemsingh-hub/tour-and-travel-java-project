		...
		contentPane.add(l10);
                ...
                try{
                    ...
                    while(rs.next()){
                        ...
                        l5.setText(rs.getString("price"));
                        l6.setText(rs.getString("phone"));
                        l7.setText(rs.getString("person"));
                        l8.setText(rs.getString("food"));
                        l9.setText(rs.getString("ac"));
                        l10.setText(rs.getString("days"));
